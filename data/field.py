...
class Field(RawField):
    ...
    def __init__(self, sequential=True, use_vocab=True, init_token=None,
                 eos_token=None, fix_length=None, dtype=np.long,
    ...
    def __setstate__(self, state):
        state['dtype'] = getattr(np, state['dtype'])
    ...
    def process(self, batch, device=None):
        """ Process a list of examples to create a np.array.
        ...
        Returns:
            np.array: Processed object given the input
    ...
    def numericalize(self, arr, device=None):
        ...
        Arguments:
            ...
            device (str or torch.device): A string or instance of `torch.device`
                ...
                !!! DEPRECATED. SEND TO DEVICE AUTOMATICALLY THROUGH JAX. !!!
        """
